...
![](attachments/12812406/12812407.png)
...
![](attachments/12812406/12812413.png)
...
![](attachments/12812406/12812414.png)
...
***1. <u>Добавление товаров по одному.</u>*** Нажмите **Добавить** во вкладке спецификации, появиться пустая строка. Кликните в столбце **Номенклатура**, и выберите товар в открывшемся окне номенклатур. Товар отобразиться в строке. Введите количество в соответствующем столбце.

![](attachments/12812406/12812411.png)

*Рис. 4 Добавление товара в Спецификацию*

  

***2. <u>Добавление товаров списком.</u>*** Перейдите во вкладку **Подбор**. В правом блоке будут отображены все товары из **Категории**, выбранной в левом блоке. Все товары, для которых вы укажете количество, будут автоматически отображены в спецификации. В столбце ***Доступно*** показано количество товаров, которые есть в вашем распоряжении, т.е. находятся на складе и не зарезервированы для других покупателей.

![](attachments/12812406/12812410.png)
...
![](attachments/12812406/12812409.png)
...
![](attachments/12812406/12812408.png)
...
| <strong>Закрыт</strong>      | <strong>Отменить</strong>/<strong>Печать</strong>                                                      | Выполненный заказ при необходимости можно [**Отменить**](Purchase_order_cancellation.md) или напечатать.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
